...
<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <h2 class="fw-bold text-primary mb-0">Editar Barbeiro</h2>
                ...
                <form action="{{ route('barbers.update', $barber->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light" id="nome" name="nome" value="{{ old('nome', $barber->nome) }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label fw-semibold">E-mail <span class="text-danger">*</span></label>
                            <input type="email" class="form-control bg-light" id="email" name="email" value="{{ old('email', $barber->email) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light" id="telefone" name="telefone" value="{{ old('telefone', $barber->telefone) }}">
                        </div>
                        <div class="col-md-6">
                            <label for="foto" class="form-label fw-semibold">Atualizar Foto (opcional)</label>
                            <input class="form-control bg-light" type="file" id="foto" name="foto" accept="image/*">
                            @if($barber->foto)
                                <div class="mt-2 text-muted small">
                                    <i class="fa-solid fa-image me-1"></i> Possui foto atualmente.
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="form-check form-switch mt-4">
                                <input class="form-check-input" type="checkbox" role="switch" id="ativo" name="ativo" {{ $barber->ativo ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <button type="submit" class="btn btn-primary btn-lg fw-bold px-5 rounded-3">
                            <i class="fa-solid fa-floppy-disk me-2"></i> Atualizar Barbeiro
                        </button>
                    </div>
