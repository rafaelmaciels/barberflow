                ...
                if (data.length === 0) {
                    queueContainer.parentElement.innerHTML = `
                        <div class="card-header bg-dark text-white rounded-top-4 py-3 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold"><i class="fa-solid fa-list-ul fa-fw me-2 text-warning"></i> Fila de Atendimento</h5>
                    ...
                    data.forEach((apt, index) => {
                        html += `
                        <div class="card shadow border-0 mb-3 rounded-4 overflow-hidden" style="background: white;">
                            <div class="card-body p-3 d-flex align-items-center">
                                <div class="bg-primary text-white d-flex justify-content-center align-items-center px-3 py-2 rounded-3 me-3 shadow-sm" style="font-weight: bold; font-size: 1.1rem;">
                                    ${apt.hora}
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="fw-bold mb-1 text-dark" style="font-size: 1.1rem;">${apt.cliente_nome} <span class="fw-normal text-muted">...</span></h6>
                                    <div class="text-secondary small fw-semibold"><i class="fa-solid fa-star fa-fw me-1 text-warning"></i>${apt.service_nome}</div>
                                </div>
                            </div>
                        </div>`;
                    });
